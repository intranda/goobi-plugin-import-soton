...
public class SotonCatalogueImport implements IImportPlugin, IPlugin {
    ...
    public Fileformat convertData() {
        ...
        } catch (JDOMException | IOException | PreferencesException | TypeNotAllowedForParentException | MetadataTypeNotAllowedException | DocStructHasNoTypeException | TypeNotAllowedAsChildException e) {
