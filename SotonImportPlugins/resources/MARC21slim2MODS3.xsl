<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink"
	...
	<xsl:template name="marcRecord">
		...
		<!--old 7XXs <xsl:for-each select="datafield[@tag='700'][not(subfield[@code='t'])]"> <name type="personal"> <xsl:call-template name="nameABCDQ"/> <xsl:call-template 
			name="affiliation"/> <xsl:call-template name="role"/> </name> </xsl:for-each> <xsl:for-each select="datafield[@tag='710'][not(subfield[@code='t'])]"> <name 
			type="corporate"> <xsl:call-template name="nameABCDN"/> <xsl:call-template name="role"/> </name> </xsl:for-each> <xsl:for-each select="datafield[@tag='711'][not(subfield[@code='t'])]"> 
			<name type="conference"> <xsl:call-template name="nameACDEQ"/> <xsl:call-template name="role"/> </name> </xsl:for-each> <xsl:for-each select="datafield[@tag='720'][not(subfield[@code='t'])]"> 
			<name> <xsl:if test="@ind1=1"> <xsl:attribute name="type"> <xsl:text>personal</xsl:text> </xsl:attribute> </xsl:if> <namePart> <xsl:value-of select="subfield[@code='a']"/> 
			</namePart> <xsl:call-template name="role"/> </name> </xsl:for-each> -->
		...
		<originInfo>
			...
			<xsl:for-each select="leader">
				<issuance>
					<xsl:choose>
						...
						<xsl:when test="$leader7='m' and ($leader19='#')">
							single unit
						</xsl:when>
						<xsl:when test="$leader7='i'">
			...
			<xsl:for-each select="controlfield[@tag=008]">
				...
				<frequency>
					<xsl:choose>
						<xsl:when test="$controlField008-18='a'">
							Annual
						</xsl:when>
						<xsl:when test="$controlField008-18='b'">
							Bimonthly
						</xsl:when>
						<xsl:when test="$controlField008-18='c'">
							Semiweekly
						</xsl:when>
						<xsl:when test="$controlField008-18='d'">
							Daily
						</xsl:when>
						<xsl:when test="$controlField008-18='e'">
							Biweekly
						</xsl:when>
						<xsl:when test="$controlField008-18='f'">
							Semiannual
						</xsl:when>
						<xsl:when test="$controlField008-18='g'">
							Biennial
						</xsl:when>
						<xsl:when test="$controlField008-18='h'">
							Triennial
						</xsl:when>
						<xsl:when test="$controlField008-18='i'">
							Three times a week
						</xsl:when>
						<xsl:when test="$controlField008-18='j'">
							Three times a month
						</xsl:when>
						<xsl:when test="$controlField008-18='k'">
							Continuously updated
						</xsl:when>
						<xsl:when test="$controlField008-18='m'">
							Monthly
						</xsl:when>
						<xsl:when test="$controlField008-18='q'">
							Quarterly
						</xsl:when>
						<xsl:when test="$controlField008-18='s'">
							Semimonthly
						</xsl:when>
						<xsl:when test="$controlField008-18='t'">
							Three times a year
						</xsl:when>
						<xsl:when test="$controlField008-18='u'">
							Unknown
						</xsl:when>
						<xsl:when test="$controlField008-18='w'">
							Weekly
						</xsl:when>
						<xsl:when test="$controlField008-18='#'">
		...
		<xsl:for-each select="datafield[@tag=041]">
			<xsl:for-each select="subfield[@code='a' or @code='b' or @code='d' or @code='e' or @code='f' or @code='g' or @code='h']">
		...
		<xsl:variable name="physicalDescription">
			...
			<xsl:for-each select="datafield[@tag=856]/subfield[@code='q'][string-length(.)&gt;1]">
				<internetMediaType>
					<xsl:value-of select="." />
				</internetMediaType>
			</xsl:for-each>
		...
		<!-- 1.32 tmee Drop note mapping for 510 and map only to <relatedItem> <xsl:for-each select="datafield[@tag=510]"> <note type="citation/reference"> <xsl:call-template 
			name="uri"/> <xsl:variable name="str"> <xsl:for-each select="subfield[@code!='6' or @code!='8']"> <xsl:value-of select="."/> <xsl:text> </xsl:text> </xsl:for-each> 
						...
						<xsl:call-template name="chopPunctuation">
							<xsl:with-param name="chopString">
								<xsl:call-template name="specialSubfieldSelect">
									...
									<xsl:with-param name="afterCodes">
										g
									</xsl:with-param>
								</xsl:call-template>
							</xsl:with-param>
				...
				<name type="personal">
					<namePart>
						<xsl:call-template name="specialSubfieldSelect">
							...
							<xsl:with-param name="beforeCodes">
								g
							</xsl:with-param>
						</xsl:call-template>
					</namePart>
		...
		<xsl:for-each select="datafield[@tag='035'][subfield[@code='a'][contains(text(), '(OCoLC)')]]">
			<identifier type="oclc">
				<xsl:value-of select="normalize-space(substring-after(subfield[@code='a'], '(OCoLC)'))" />
			</identifier>
		</xsl:for-each>
		...
		<xsl:for-each select="datafield[@tag='091']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>
		<xsl:for-each select="datafield[@tag='092']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>
		<xsl:for-each select="datafield[@tag='093']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>
		<xsl:for-each select="datafield[@tag='094']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>
		<xsl:for-each select="datafield[@tag='095']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>
		<xsl:for-each select="datafield[@tag='096']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>

		<xsl:for-each select="datafield[@tag='097']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>
		<xsl:for-each select="datafield[@tag='098']">
			<identifier type="local" displayLabel="Call number">
				<xsl:value-of select="subfield" />
			</identifier>
		</xsl:for-each>
		...
		<xsl:for-each select="datafield[@tag='591']">
			<xsl:for-each select="subfield">
				<note>
					<xsl:value-of select="." />
				</note>
		...
		<xsl:for-each select="datafield[@tag='592']">
			<xsl:for-each select="subfield">
				<note>
					<xsl:value-of select="." />
				</note>
		...
		<xsl:for-each select="datafield[@tag='593']">
			<xsl:for-each select="subfield">
				<note>
					<xsl:value-of select="." />
				</note>
		...
		<xsl:for-each select="datafield[@tag='597']">
			<xsl:for-each select="subfield">
				<note>
					<xsl:value-of select="." />
				</note>
		...
		<xsl:for-each select="datafield[@tag='598']">
			<xsl:for-each select="subfield">
				<note>
					<xsl:value-of select="." />
				</note>
		...
		<xsl:for-each select="datafield[@tag='691']">
			<xsl:for-each select="subfield">
				<subject>
					<topic>
						<xsl:value-of select="." />
		...
		<xsl:for-each select="datafield[@tag='694']">
			<xsl:for-each select="subfield">
				<subject>
					<topic>
						<xsl:value-of select="." />
		...
		<xsl:for-each select="datafield[@tag='695']">
			<xsl:for-each select="subfield">
				<subject>
					<topic>
						<xsl:value-of select="." />
		...
		<xsl:for-each select="datafield[@tag='696']">
			<xsl:for-each select="subfield">
				<subject>
					<topic>
						<xsl:value-of select="." />
		...
		<xsl:for-each select="datafield[@tag='698']">
			<xsl:for-each select="subfield">
				<subject>
					<topic>
						<xsl:value-of select="." />
		...
		<xsl:for-each select="datafield[@tag='699']">
			<xsl:for-each select="subfield">
				<subject>
					<topic>
						<xsl:value-of select="." />
		...
		<xsl:for-each select="datafield[@tag='856'][subfield[@code='u']]">
			<xsl:if
				...
				<identifier>
					<xsl:attribute name="type">
						<xsl:if test="starts-with(subfield[@code='u'],'urn:doi') or starts-with(subfield[@code='u'],'doi')">doi</xsl:if>
						<xsl:if
						test="starts-with(subfield[@code='u'],'urn:hdl') or starts-with(subfield[@code='u'],'hdl') or starts-with(subfield[@code='u'],'http://hdl.loc.gov')">hdl</xsl:if>
					</xsl:attribute>
					<xsl:value-of select="concat('hdl:',substring-after(subfield[@code='u'],'http://hdl.loc.gov/'))" />
				</identifier>
			</xsl:if>


			<xsl:if test="starts-with(subfield[@code='u'],'urn:hdl') or starts-with(subfield[@code='u'],'hdl')">
				<identifier type="hdl">
	...
	<!-- isInvalid <xsl:template name="isInvalid"> <xsl:param name="type"/> <xsl:if test="subfield[@code='z'] or subfield[@code='y'] or subfield[@code='m']"> 
		<identifier> <xsl:attribute name="type"> <xsl:value-of select="$type"/> </xsl:attribute> <xsl:attribute name="invalid"> <xsl:text>yes</xsl:text> </xsl:attribute> 
		<xsl:if test="subfield[@code='z']"> <xsl:value-of select="subfield[@code='z']"/> </xsl:if> <xsl:if test="subfield[@code='y']"> <xsl:value-of select="subfield[@code='y']"/> 
		</xsl:if> <xsl:if test="subfield[@code='m']"> <xsl:value-of select="subfield[@code='m']"/> </xsl:if> </identifier> </xsl:if> </xsl:template> -->
		...
		<xsl:if test="subfield[@code='b']">
			<subTitle>
				<xsl:call-template name="chopPunctuation">
					<xsl:with-param name="chopString">
						<xsl:value-of select="subfield[@code='b']" />
						<!--<xsl:call-template name="subfieldSelect"> <xsl:with-param name="codes">b</xsl:with-param> </xsl:call-template> -->
					</xsl:with-param>
				</xsl:call-template>
			</subTitle>
		</xsl:if>
	...
	<xsl:template name="createTitleInfoFrom240">
		<titleInfo type="uniform">
			<xsl:if test="//datafield[@tag='100']|//datafield[@tag='110']|//datafield[@tag='111']">
	...
	<xsl:template name="createNoteFrom245c">
		<xsl:choose>
			<xsl:when test="//datafield[@tag='245'] and //datafield[@tag=880]/subfield[@code=6][contains(text(),'245')]">
	...
	<xsl:template name="createNoteFrom508">
		<note type="creation/production credits">
			...
			<xsl:call-template name="uri" />
			<xsl:variable name="str">
				<xsl:for-each select="subfield[@code!='u' and @code!='3' and @code!='6' and @code!='8']">
					<xsl:value-of select="." />
					<xsl:text> </xsl:text>
				</xsl:for-each>
			</xsl:variable>
